<template>
	<Teleport to="body">
		<Modal @click-outside="showModal = false">
							...
							<div class="flex flex-col gap-4 mt-2 mb-6">
								...
								<div v-for="(colorRangeValue, i) in colorRangeValues" :key="colorRangeValue.name" class="grid grid-flow-col-dense grid-rows-1 gap-2 items-start">
									...
									<div class="flex flex-col items-center">
										...
										>Name</label>
										<input
											class="rounded-lg p-2 disabled:text-stone-700 w-full disabled:bg-stone-400 dark:disabled:bg-stone-400"
											type="text"
...
const colorRangeValues = reactive<ColorRange[]>([
	{
		coordinates: [{ x: -1, y: -1 }, { x: 1, y: 0 }],
		color: "#0081C9",
		name: "water",
	},
	{
		coordinates: [{ x: -1, y: 0 }, { x: 1, y: 0.1 }],
		color: "#FFD56F",
		name: "sand",
	},
	{
		coordinates: [{ x: -1, y: 0.1 }, { x: 0, y: 0.5 }],
		color: "#367E18",
		name: "grass",
	},
	{
		coordinates: [{ x: 0, y: 0.1 }, { x: 1, y: 0.5 }],
		color: "#264d16",
		name: "forest",
	},
	{
		coordinates: [{ x: -1, y: 0.5 }, { x: 1, y: 1 }],
		color: "#473C33",
		name: "rock",
	},
]);
...
const editColorRange = ref<ColorRange | undefined>(undefined);
...
function openModal(i: number): void {
	editColorRange.value = colorRangeValues[i];
